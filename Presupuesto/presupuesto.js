...
function validar() {
    ...
    if (document.getElementById("gasto").value == "") {
        document.getElementById("alert-content").textContent = " Debe ingresar un nombre en la casilla de gasto para poder continuar con la operacion"
        showAlert()
    }
        ...
        else{ document.getElementById("alert-content").textContent = "No dispone de saldo suficiente para ese gasto"
        showAlert()
        ...
        document.getElementById("alert-content").textContent = " Debe ingresar un valor en la casilla de cantidad para poder continuar con la operacion"
        showAlert()
    }
